...
import (
	...
	dnsutils "sigs.k8s.io/cluster-api-provider-digitalocean/utils/dns"
	dnsresolver "sigs.k8s.io/cluster-api-provider-digitalocean/utils/dns/resolver"
...
func main() {
	...
	dnsutils.InitFromDNSResolver(dnsresolver)
